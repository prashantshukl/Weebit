  ...
  return (
    <form onSubmit={onSubmitHandler} className='flex flex-col items-center w-[90%] sm:max-w-90 m-auto mt-14 gap-4 text-gray-800'>
      ...
      <div className='w-full flex justify-between text-sm mt-[-8px]'>
        ...
        {
          currentState === 'Sign Up' ? <p onClick={()=>setCurrentState('Login')} className='cursor-pointer'>Login Here</p> : <p onClick={()=>setCurrentState('Sign Up')} className='cursor-pointer'>Create Account</p>
        }
      </div>
